package com.github.indrabasak.shiuli.example.config;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("book")
                .select()
                .apis(basePackage("com.github.indrabasak.shiuli.example.controller"))
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("Team Shiuli", "",
                                      "indra.basak1@google.com");
